...
if ($.isNode())
{
    ...
    if (process.env.TURNTABLEHEADER && process.env.TURNTABLEHEADER.indexOf('#') > -1)
    {
        turntableurl = process.env.TURNTABLEHEADER.split('#');
    }
    else if (process.env.TURNTABLEHEADER && process.env.TURNTABLEHEADER.split('\n')
        .length > 0)
    {
        turntableurl = process.env.TURNTABLEHEADER.split('\n');
    }
    ...
    {
        turntableheader = process.env.DOUBLEHEADER.split('#');
    }
    else if (process.env.DOUBLEHEADER && process.env.DOUBLEHEADER.indexOf('\n') > -1)
    {
        turntableheader = process.env.DOUBLEHEADER.split('\n');
    }
    else
    ...
    if (process.env.CARDBODY && process.env.TURNTABLEHEADER.indexOf('#') > -1)
    {
